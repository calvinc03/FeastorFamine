...
void add_frames_FK(entt::entity entity, Rig rig, FK_Animations& fk_animations) {
...
void add_attack(entt::entity entity, Rig rig, FK_Animations& fk_animations) {
    ...
    j2.data.emplace(t_fireball, -3.6f);
...
void add_attack2(entt::entity, Rig rig, FK_Animations& fk_animations) {
